...
class TravelPackageModel {
  ...
  factory TravelPackageModel.fromFlight({
  ...
  factory TravelPackageModel.fromAttraction({
    required String packageId,
    required String tripId,
  ...
  factory TravelPackageModel.fromRestaurant({
    required String packageId,
    required String tripId,
  ...
  factory TravelPackageModel.fromAccommodation({
    required String packageId,
    required String tripId,
