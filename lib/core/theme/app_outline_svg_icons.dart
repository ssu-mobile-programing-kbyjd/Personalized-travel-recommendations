...
class AppOutlineSvgIcons {
  static Widget icon(
    ...
    try {
      return SvgPicture.asset(
        'assets/icons/Outline/svg 1x/$name.svg',
        width: size,
        height: size,
        colorFilter:
  ...
  static Widget arrowsExpand({
    double size = 24,
    Color? color,
  }) =>
      icon('arrows-expand', size: size, color: color);

  static Widget atSymbol({
    double size = 24,
    Color? color,
  }) =>
  ...
  static Widget calculator({
    ...
    Color? color,
      ...
      icon('calculator', size: size, color: color);
  ...
  static Widget chatAlt2({
    double size = 24,
    Color? color,
  }) =>
      icon('chat-alt-2', size: size, color: color);

  static Widget chatAlt({
    double size = 24,
    Color? color,
  }) =>
  ...
  static Widget deviceTablet({
    double size = 24,
    Color? color,
  }) =>
      icon('device-tablet', size: size, color: color);

  static Widget documentAdd({
    double size = 24,
    Color? color,
  }) =>
  ...
  static Widget informationCircle({
    double size = 24,
    Color? color,
  }) =>
  ...
  static Widget lockClosed({
    double size = 24,
    Color? color,
  }) =>
      icon('lock-closed', size: size, color: color);

  static Widget lockOpen({
    double size = 24,
    Color? color,
  }) =>
  ...
  static Widget newspaper({
    double size = 24,
    Color? color,
  }) =>
      icon('newspaper', size: size, color: color);

  static Widget officeBuilding({
    double size = 24,
    Color? color,
  }) =>
      icon('office-building', size: size, color: color);

  static Widget paperAirplane({
    double size = 24,
    Color? color,
  }) =>
  ...
  static Widget presentationChartBar({
    double size = 24,
    Color? color,
  }) =>
      icon('presentation-chart-bar', size: size, color: color);

  static Widget presentationChartLine({
    double size = 24,
    Color? color,
  }) =>
  ...
  static Widget receiptRefund({
    double size = 24,
    Color? color,
  }) =>
      icon('receipt-refund', size: size, color: color);

  static Widget receiptTax({
    double size = 24,
    Color? color,
  }) =>
  ...
  static Widget shieldExclamation({
    double size = 24,
    Color? color,
  }) =>
  ...
  static Widget sortAscending({
    double size = 24,
    Color? color,
  }) =>
      icon('sort-ascending', size: size, color: color);

  static Widget sortDescending({
    double size = 24,
    Color? color,
  }) =>
  ...
  static Widget statusOffline({
    double size = 24,
    Color? color,
  }) =>
      icon('status-offline', size: size, color: color);

  static Widget statusOnline({
    double size = 24,
    Color? color,
  }) =>
  ...
  static Widget switchHorizontal({
    double size = 24,
    Color? color,
  }) =>
      icon('switch-horizontal', size: size, color: color);

  static Widget switchVertical({
    double size = 24,
    Color? color,
  }) =>
  ...
  // 예시: svg 1x 폴더 내 모든 아이콘에 대해 위와 같이 추가
  // ...existing code...
}
