...
class AppOutlinePngIcons {
  static Widget icon(String name, {double size = 24, Color? color}) {
    try {
      return Image.asset(
        'assets/icons/Outline/png/$name.png',
        width: size,
        height: size,
        color: color,
      );
  ...
  static Widget navcalendar({double size = 24, Color? color}) =>
      icon('navcalendar', size: size, color: color);
  ...
  static Widget navhome({double size = 24, Color? color}) =>
      icon('navhome', size: size, color: color);
  ...
  static Widget place({double size = 24, Color? color}) =>
      icon('place', size: size, color: color);
  ...
  static Widget tastehouse({double size = 24, Color? color}) =>
      icon('tastehouse', size: size, color: color);

  static Widget flight({double size = 24, Color? color}) =>
      icon('tdesign_flight-takeoff', size: size, color: color);
